---
title: "2023 年におけるReactを使った開発の最適なライブラリ・フレームワークは何か"
...
例えば、Remix製のアプリにi18n（多言語化対応）を行う必要があったのですが、2023年時点では公式によるドキュメントはなく、Remix向けの多言語化対応のライブラリも１種類しか存在していませんでした。大規模サービスや長期運用を念頭に置く場合、コミュニティやライブラリサポートがまだ手薄と感じるため本番利用は慎重になるべきだと考えます。
