...
description: "2025年5月現在、AI駆動開発に関する知見。Cursor、Claude、MCPなどのツールの紹介と、今後の展望などに関する私見。"
...
この記事を書いた後に Claude Code が正式にリリースされ、ソフトウェア開発という分野ではエージェントが更に主体になりつつあると感じています。
